...
public class Constants {
    ...
    public static final String MESSAGE_UNAUTHORISED = "Unauthorised Access : User invalid or password incorrect";
    public static final int CODE_INVALID = 301;
    public static final String MESSAGE_INVALID_LOGIN = "Email or password incorrect";
    public static final String MESSAGE_INVALID_USER_ID = "Invalid User ID : Id is null, non-numeric or not present";
    public static final String MESSAGE_INVALID_PRODUCT_ID = "Invalid Product ID : Id is null, non-numeric or not present";
    ...
    public static final String MESSAGE_INVALID_PASSWORD = "Invalid Password : Password cannot be empty";
    ...
    public static final String MESSAGE_DUPLICATE_PRODUCT = "Duplicate Product : A product with same name already exists in specified category";
    public static final int CODE_EXCEEDED = 302;
    public static final String MESSAGE_EXCEEDED_CART = "Item cannot be added to cart as requested quantity is not present in inventory";
